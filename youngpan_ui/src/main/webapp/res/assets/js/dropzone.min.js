							...
							j = (function(o) {
								...
								n.prototype.defaultOptions = {
									...
									addedfile : function(q) {
										...
										var temp = q.previewElement.querySelector("[data-dz-name]");
										q.previewElement
												.querySelector("[data-dz-name]").textContent = q.name;
										//q.previewElement
										//		.querySelector("[data-dz-name]").innerHTML = '<textarea cols="5" style="height:90px">'+q.name+'</textarea>';
										q.previewElement
												.querySelector("[data-dz-size]").innerHTML = this
												.filesize(q.size);
										if (this.options.addRemoveLinks) {
											q._removeLink = n
													.createElement('<a class="dz-remove" href="javascript:void(0)">'
									...
									removedfile : function(q) {
										var r;
										$.ajax({
						                    url : "fileinfo/cancel.do",
						                    data : "fileName="+q.name,
						                    type : "post",
						            	});
